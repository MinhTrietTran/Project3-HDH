...
// how big is address space?
    ...
    size = numPages * PageSize;
		...
		//check the available memory enough to load new process
		 //debug
		 if(numPages > gPhysPageBitMap->NumClear()){									// THAY NUMPHYSPAGES BANG HAM TINH SO TRANG TRONG
...
// first, set up the translation
    ...
    for (i = 0; i < numPages; i++) {
			...
			pageTable[i].physicalPage = gPhysPageBitMap->Find();				// CAN THAY THE THAM SO I THANH MOT HAM CO CHUC NANG TIM TRANG TRONG VA DANH DAU LA DA SU DUNG
...
//======================================================
//AddrSpace constructor Modified
//======================================================
AddrSpace::AddrSpace(char* filename){
	NoffHeader noffH;
	unsigned int i,size, j;
	// unsigned int numCodePage,numDataPage;			//so trang cho phan code va phan initData
	// int lastCodePageSize, lastDataPageSize,firstDataPageSize,tempDataSize;	//kich thuoc ghi vao trang cuoi code, initdata, va trang dau cua initdata
