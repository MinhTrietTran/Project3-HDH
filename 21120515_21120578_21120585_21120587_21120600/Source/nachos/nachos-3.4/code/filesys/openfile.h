...
class OpenFile {
  public:
    int type;
    OpenFile(int f) { file = f; currentOffset = 0; type = 0;}	// open the file DEFAULT
    OpenFile(int f, int t){file = f, currentOffset = 0, type = t;} //open the file WITH PARAMETER type
